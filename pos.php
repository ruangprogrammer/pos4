...
$grand_total = mysqli_query($mysqli,"SELECT SUM(product_price * jumlah) AS TOTAL FROM  
    `product`
                ...
                <div class="panel-body">
                    <div class="panel-body">
                        <div id="show_product" class="media-gal">
                            <?php $queryProduct = mysqli_query($mysqli,"SELECT * FROM product");
                            while ($rowsProduct = mysqli_fetch_array($queryProduct)) { ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <!-- <td><input type="number" name="" style="width: 40px;"></td> -->
                                                            <td>
                                                                <input type="number" value="<?php echo $data['jumlah']; ?>" onchange="updateCartItem(this, '<?php echo $data["id_orders_temp"]; ?>')" style="width: 40px;">
